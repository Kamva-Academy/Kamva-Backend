...
from question_widget.models import MultiChoiceAnswer, ShortAnswer
...
class RegistrationReceipt(Receipt):
    ...
    answer_sheet_of = models.ForeignKey('my_form.RegistrationForm', related_name='registration_receipts', null=True, blank=True,
