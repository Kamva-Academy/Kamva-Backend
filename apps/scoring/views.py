...
from apps.fsm.models import Answer
from apps.scoring.models import ScoreType, Score, Comment
from apps.scoring.serializers.score_serializers import ScoreTypeSerializer, ScoreSerializer, CommentSerializer
