...
from apps.fsm.models import CertificateTemplate, Font
from apps.fsm.permissions import IsCertificateTemplateModifier
from apps.fsm.serializers.certificate_serializer import CertificateTemplateSerializer, FontSerializer
