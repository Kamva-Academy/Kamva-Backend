...
class Question(Widget):
    ...
    def unfinalize_older_answers(self, user):
        from apps.fsm.models import NEWState, Team
...
class ShortAnswer(Answer):
    problem = models.ForeignKey('question_widget.ShortAnswerQuestion', null=True,
...
class LongAnswer(Answer):
    problem = models.ForeignKey('question_widget.LongAnswerQuestion', null=True, blank=True, on_delete=models.CASCADE,
...
class MultiChoiceAnswer(Answer):
    problem = models.ForeignKey('question_widget.MultiChoiceQuestion', null=True, blank=True, on_delete=models.CASCADE,
                                related_name='answers')
...
class UploadFileAnswer(Answer):
    problem = models.ForeignKey('question_widget.UploadFileQuestion', null=True, blank=True, on_delete=models.CASCADE,
                                related_name='answers')
