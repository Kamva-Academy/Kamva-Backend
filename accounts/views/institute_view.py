...
from accounts.models import EducationalInstitute
from accounts.permissions import IsInstituteOwner, IsInstituteAdmin
from accounts.serializers import InstituteSerializer, AccountSerializer
